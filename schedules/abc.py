...
def main():
    ...
    schedule.every().day.at("04:00", "Australia/Sydney").do(abc_schedule.abc_job)
    schedule.every().day.at("05:00", "Australia/Sydney").do(abc_schedule.abc_job)
    ...
    schedule.every().day.at("09:30", "Australia/Sydney").do(abc_schedule.abc_job)
    schedule.every().day.at("10:00", "Australia/Sydney").do(abc_schedule.abc_job)
    schedule.every().day.at("10:30", "Australia/Sydney").do(abc_schedule.abc_job)
