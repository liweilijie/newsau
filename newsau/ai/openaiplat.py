            ...
            try:
                ...
                completion = self.client.chat.completions.create(
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": "你是一个中英文翻译专家，用户需要将很多英文标题翻译成中文，并且控制内容在512个字以内，翻译的内容要确保符合中文语言习惯，利用新闻风格来调整语气和风格，并考虑到某些词语的文化内涵和地区差异。同时作为翻译家，需将原文翻译成具有信达雅标准的译文。\"信\" 即忠实于原文的内容与意图；\"达\" 意味着译文应通顺易懂，表达清晰；\"雅\" 则追求译文的文化审美和语言的优美。目标是创作出既忠于原作精神，又符合目标语言文化和读者审美的翻译。"
                        },
                        {
                            "role": "user",
                            "content": tr_title
